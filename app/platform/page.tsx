...
export const metadata: Metadata = {
  ...
  description:
    'Explore the ETC platform: PPA Marketplace, Asset Exchange, BESS Exchange, Analytics Engine, 24/7 CFE Matching, Grid Intelligence, and full deal lifecycle management.',
